 ...
 * Name:             CreateDocument
 *
 * Full name:        System`CreateDocument
 *
 ...
 *                   CreateDocument[{expr , expr , …}] creates and opens a document notebook consisting of a sequence of cells containing the expr .
 *                                       1      2                                                                                                 i
 * Usage:            CreateDocument[expr, obj] replaces the notebook represented by the notebook object obj with the one obtained from expr.
 *
 ...
 *
 *                   local: paclet:ref/CreateDocument
 * Documentation:    web: http://reference.wolfram.com/language/ref/CreateDocument.html
 *
 * Definitions:      None
 *
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun createDocument(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("CreateDocument", arguments.toMutableList(), options)
}
