 ...
 *````
 *
 * Name:             IndexEdgeTaggedGraph
 *
 * Full name:        System`IndexEdgeTaggedGraph
 *
 *                   IndexEdgeTaggedGraph[g] sets tags of edges in the graph g to their edge indices.
 * Usage:            IndexEdgeTaggedGraph[g, r] sets tags of edges to r, r + 1, …
 *
 ...
 *
 *                   local: paclet:ref/IndexEdgeTaggedGraph
 * Documentation:    web: http://reference.wolfram.com/language/ref/IndexEdgeTaggedGraph.html
 *
 * Definitions:      None
 *
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun indexEdgeTaggedGraph(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("IndexEdgeTaggedGraph", arguments.toMutableList(), options)
}
