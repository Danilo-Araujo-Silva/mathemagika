 ...
 * Name:             Input
 *
 * Full name:        System`Input
 *
 *                   Input[] interactively reads in one Wolfram Language expression.
 *                   Input[prompt] requests input, displaying prompt as a "prompt".
 * Usage:            Input[prompt, init] in a notebook front end uses init as the initial contents of the input field.
 *
 ...
 *
 *                   local: paclet:ref/Input
 * Documentation:    web: http://reference.wolfram.com/language/ref/Input.html
 *
 * Definitions:      None
 *
 * Own values:       None
