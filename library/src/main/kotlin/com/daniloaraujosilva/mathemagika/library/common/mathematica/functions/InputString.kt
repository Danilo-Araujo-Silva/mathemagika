 ...
 * Name:             InputString
 *
 * Full name:        System`InputString
 *
 *                   InputString[] interactively reads in a character string.
 *                   InputString[prompt] requests input, displaying prompt as a "prompt".
 * Usage:            InputString[prompt, init] in a notebook front end uses init as the initial contents of the input field.
 *
 ...
 *
 *                   local: paclet:ref/InputString
 * Documentation:    web: http://reference.wolfram.com/language/ref/InputString.html
 *
 * Definitions:      None
 *
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun inputString(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("InputString", arguments.toMutableList(), options)
}
