 ...
 * Numeric values:   None
 */
fun `null`(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("Null", arguments.toMutableList(), options)
}
