 ...
 *````
 *
 * Name:             DateObject[{2020, 6, 10}, Day, Gregorian, -3.]
 *
 ...
 */
fun today(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("Today", arguments.toMutableList(), options)
}
