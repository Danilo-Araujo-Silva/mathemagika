 ...
 *
 * Full name:        System`UndirectedGraph
 *
 *                   UndirectedGraph[g] gives an undirected graph from the directed graph g.
 * Usage:            UndirectedGraph[{v  w, …}] uses rules v  w to specify the graph g.
 *
 ...
 *
 *                   local: paclet:ref/UndirectedGraph
 * Documentation:    web: http://reference.wolfram.com/language/ref/UndirectedGraph.html
 *
 * Definitions:      None
 *
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun undirectedGraph(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("UndirectedGraph", arguments.toMutableList(), options)
}
