 ...
 *
 * Full name:        System`AuthenticationDialog
 *
 *                   AuthenticationDialog[] initiates a standard dialog for entering username/password authentication information.
 *                   AuthenticationDialog["type"] initiates an authentication dialog of the specified standard type.
 *                   AuthenticationDialog[{key , key , …}] initiates an authentication dialog that requests values for the specified keys.
 *                                            1     2
 * Usage:            AuthenticationDialog[arg, func] applies the function func to the dialog's return value.
 *
 ...
 * Options:          SystemCredentialKey -> None
 *
 *                   Protected
 * Attributes:       ReadProtected
 *
 *                   local: paclet:ref/AuthenticationDialog
 * Documentation:    web: http://reference.wolfram.com/language/ref/AuthenticationDialog.html
 *
 * Definitions:      None
 *
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun authenticationDialog(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("AuthenticationDialog", arguments.toMutableList(), options)
}
