 ...
 * Numeric values:   None
 */
fun automatic(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("Automatic", arguments.toMutableList(), options)
}
