 ...
 *
 * Full name:        System`ExpressionGraph
 *
 ...
 * Usage:            ExpressionGraph[expr, n, form] gives a tree graph in which subexpressions that match form are leaves.
 *
 ...
 *
 *                   local: paclet:ref/ExpressionGraph
 * Documentation:    web: http://reference.wolfram.com/language/ref/ExpressionGraph.html
 *
 * Definitions:      None
 *
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun expressionGraph(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("ExpressionGraph", arguments.toMutableList(), options)
}
