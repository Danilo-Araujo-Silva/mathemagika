 ...
 * Name:             KaryTree
 *
 * Full name:        System`KaryTree
 *
 *                   KaryTree[n] gives a binary tree with n vertices.
 * Usage:            KaryTree[n, k] gives a k-ary tree with n vertices.
 *
 ...
 *
 *                   local: paclet:ref/KaryTree
 * Documentation:    web: http://reference.wolfram.com/language/ref/KaryTree.html
 *
 * Definitions:      None
 *
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun karyTree(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("KaryTree", arguments.toMutableList(), options)
}
