 ...
 *````
 *
 * Name:             PaletteNotebook
 *
 * Full name:        System`PaletteNotebook
 *
 *                   PaletteNotebook[{cell , cell , …}] represents a palette notebook that can be manipulated by the Wolfram System front end.
 * Usage:                                 1      2
 *
 ...
 *
 *                   local: paclet:ref/PaletteNotebook
 * Documentation:    web: http://reference.wolfram.com/language/ref/PaletteNotebook.html
 *
 * Definitions:      None
 *
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun paletteNotebook(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("PaletteNotebook", arguments.toMutableList(), options)
}
