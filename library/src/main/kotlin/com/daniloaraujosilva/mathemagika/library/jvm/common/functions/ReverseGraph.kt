 ...
 * Name:             ReverseGraph
 *
 * Full name:        System`ReverseGraph
 *
 *                   ReverseGraph[g] gives the reverse graph of the directed graph g.
 * Usage:            ReverseGraph[{v  w, …}] uses rules v  w to specify the graph g.
 *
 ...
 *
 *                   local: paclet:ref/ReverseGraph
 * Documentation:    web: http://reference.wolfram.com/language/ref/ReverseGraph.html
 *
 * Definitions:      None
 *
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun reverseGraph(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("ReverseGraph", arguments.toMutableList(), options)
}
