 ...
 * Name:             SimpleGraph
 *
 * Full name:        System`SimpleGraph
 *
 *                   SimpleGraph[g] gives the underlying simple graph from the graph g.
 * Usage:            SimpleGraph[{v  w, …}] uses rules v  w to specify the graph g.
 *
 ...
 *
 *                   local: paclet:ref/SimpleGraph
 * Documentation:    web: http://reference.wolfram.com/language/ref/SimpleGraph.html
 *
 * Definitions:      None
 *
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun simpleGraph(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("SimpleGraph", arguments.toMutableList(), options)
}
