 ...
 *                   ChoiceDialog[expr, {lbl   val , lbl   val , …}] includes buttons with labels lbl , and returns the corresponding val  for the button clicked.
 * Usage:                                   1      1     2      2                                      i                                   i
 * 
 ...
 * 
 *                   local: paclet:ref/ChoiceDialog
 * Documentation:    web: http://reference.wolfram.com/language/ref/ChoiceDialog.html
 * 
 * Definitions:      None
 * 
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun choiceDialog(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("ChoiceDialog", arguments.toMutableList(), options)
}
