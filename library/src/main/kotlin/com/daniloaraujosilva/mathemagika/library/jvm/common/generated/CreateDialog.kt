 ...
 * Name:             CreateDialog
 * 
 * Full name:        System`CreateDialog
 * 
 *                   CreateDialog[expr] creates a dialog notebook containing expr and opens it in the front end.
 * Usage:            CreateDialog[expr, obj] replaces the notebook represented by the notebook object obj with the one obtained from expr.
 * 
 ...
 * 
 *                   local: paclet:ref/CreateDialog
 * Documentation:    web: http://reference.wolfram.com/language/ref/CreateDialog.html
 * 
 * Definitions:      None
 * 
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun createDialog(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("CreateDialog", arguments.toMutableList(), options)
}
