 ...
 * Name:             CreatePalette
 * 
 * Full name:        System`CreatePalette
 * 
 *                   CreatePalette[expr] creates a palette notebook containing expr, and opens it in the front end.
 *                   CreatePalette[{expr , expr , …}] creates and opens a palette notebook consisting of a sequence of cells containing the expr .
 *                                      1      2                                                                                                i
 * Usage:            CreatePalette[expr, obj] replaces the notebook represented by the notebook object obj with the one obtained from expr.
 * 
 ...
 * 
 *                   local: paclet:ref/CreatePalette
 * Documentation:    web: http://reference.wolfram.com/language/ref/CreatePalette.html
 * 
 * Definitions:      None
 * 
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun createPalette(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("CreatePalette", arguments.toMutableList(), options)
}
