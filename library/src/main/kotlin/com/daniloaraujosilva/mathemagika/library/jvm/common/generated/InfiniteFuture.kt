 ...
 */
fun infiniteFuture(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("InfiniteFuture", arguments.toMutableList(), options)
}
