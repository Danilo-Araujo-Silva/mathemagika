 ...
 * Usage:            RandomGraph[gdist, …] samples from the random graph distribution gdist.
 * 
 ...
 * 
 *                   local: paclet:ref/RandomGraph
 * Documentation:    web: http://reference.wolfram.com/language/ref/RandomGraph.html
 * 
 * Definitions:      None
 * 
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun randomGraph(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("RandomGraph", arguments.toMutableList(), options)
}
