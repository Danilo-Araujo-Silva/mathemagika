 ...
 * Name:             CreateNotebook
 *
 * Full name:        System`CreateNotebook
 *
 *                   CreateNotebook[] creates a generic empty notebook and opens it in the front end.
 *                   CreateNotebook["type"] creates an empty notebook of the specified type and opens it in the front end.
 * Usage:            CreateNotebook["type", obj] replaces the notebook represented by the notebook object obj by a version converted to be of the specified type.
 *
 ...
 *
 *                   local: paclet:ref/CreateNotebook
 * Documentation:    web: http://reference.wolfram.com/language/ref/CreateNotebook.html
 *
 * Definitions:      None
 *
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun createNotebook(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("CreateNotebook", arguments.toMutableList(), options)
}
