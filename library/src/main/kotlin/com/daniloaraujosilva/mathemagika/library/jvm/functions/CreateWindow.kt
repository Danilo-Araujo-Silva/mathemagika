 ...
 * Usage:            CreateWindow[expr, obj] replaces the notebook represented by the notebook object obj with the one obtained from expr.
 *
 ...
 *
 *                   local: paclet:ref/CreateWindow
 * Documentation:    web: http://reference.wolfram.com/language/ref/CreateWindow.html
 *
 * Definitions:      None
 *
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun createWindow(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("CreateWindow", arguments.toMutableList(), options)
}
