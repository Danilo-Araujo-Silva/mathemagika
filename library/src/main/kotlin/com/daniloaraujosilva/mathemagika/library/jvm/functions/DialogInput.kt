 ...
 *
 *                   local: paclet:ref/DialogInput
 * Documentation:    web: http://reference.wolfram.com/language/ref/DialogInput.html
 *
 * Definitions:      None
 *
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun dialogInput(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("DialogInput", arguments.toMutableList(), options)
}
