 ...
 * Name:             DialogNotebook
 *
 * Full name:        System`DialogNotebook
 *
 *                   DialogNotebook[{cell , cell , …}] represents a dialog notebook that can be manipulated by the Wolfram System front end.
 * Usage:                                1      2
 *
 ...
 *
 *                   local: paclet:ref/DialogNotebook
 * Documentation:    web: http://reference.wolfram.com/language/ref/DialogNotebook.html
 *
 * Definitions:      None
 *
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun dialogNotebook(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("DialogNotebook", arguments.toMutableList(), options)
}
