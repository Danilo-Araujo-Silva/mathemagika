 ...
 *
 * Full name:        System`DocumentNotebook
 *
 *                   DocumentNotebook[{cell , cell , …}] represents a complete document notebook in the Wolfram System front end.
 * Usage:                                  1      2
 *
 ...
 *
 *                   local: paclet:ref/DocumentNotebook
 * Documentation:    web: http://reference.wolfram.com/language/ref/DocumentNotebook.html
 *
 * Definitions:      None
 *
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun documentNotebook(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("DocumentNotebook", arguments.toMutableList(), options)
}
