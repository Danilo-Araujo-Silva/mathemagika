 ...
 * Usage:            EdgeDelete[{v  w, …}, …] uses rules v  w to specify the graph g.
 *
 ...
 *
 *                   local: paclet:ref/EdgeDelete
 * Documentation:    web: http://reference.wolfram.com/language/ref/EdgeDelete.html
 *
 * Definitions:      None
 *
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun edgeDelete(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("EdgeDelete", arguments.toMutableList(), options)
}
