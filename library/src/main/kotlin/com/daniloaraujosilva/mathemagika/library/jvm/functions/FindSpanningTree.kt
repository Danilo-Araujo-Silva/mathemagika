 ...
 *````
 *
 * Name:             FindSpanningTree
 *
 * Full name:        System`FindSpanningTree
 *
 ...
 * Usage:            FindSpanningTree[{v  w, …}, …] uses rules v  w to specify the graph g.
 *
 ...
 *
 *                   local: paclet:ref/FindSpanningTree
 * Documentation:    web: http://reference.wolfram.com/language/ref/FindSpanningTree.html
 *
 * Definitions:      None
 *
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun findSpanningTree(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("FindSpanningTree", arguments.toMutableList(), options)
}
