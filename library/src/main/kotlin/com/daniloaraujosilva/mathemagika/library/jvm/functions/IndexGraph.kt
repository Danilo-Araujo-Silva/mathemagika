 ...
 * Usage:            IndexGraph[{v  w, …}, …] uses rules v  w to specify the graph g.
 *
 ...
 *
 *                   local: paclet:ref/IndexGraph
 * Documentation:    web: http://reference.wolfram.com/language/ref/IndexGraph.html
 *
 * Definitions:      None
 *
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun indexGraph(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("IndexGraph", arguments.toMutableList(), options)
}
