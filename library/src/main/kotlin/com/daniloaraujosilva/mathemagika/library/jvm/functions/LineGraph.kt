 ...
 * Name:             LineGraph
 *
 * Full name:        System`LineGraph
 *
 *                   LineGraph[g] gives the line graph of the graph g.
 * Usage:            LineGraph[{v  w, …}] uses rules v  w to specify the graph g.
 *
 ...
 *
 *                   local: paclet:ref/LineGraph
 * Documentation:    web: http://reference.wolfram.com/language/ref/LineGraph.html
 *
 * Definitions:      None
 *
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun lineGraph(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("LineGraph", arguments.toMutableList(), options)
}
