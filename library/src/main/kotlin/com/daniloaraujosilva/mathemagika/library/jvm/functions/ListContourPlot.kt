 ...
 *
 * Full name:        System`ListContourPlot
 *
 ...
 *
 *                   local: paclet:ref/ListContourPlot
 * Documentation:    web: http://reference.wolfram.com/language/ref/ListContourPlot.html
 *
 * Definitions:      None
 *
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun listContourPlot(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("ListContourPlot", arguments.toMutableList(), options)
}
