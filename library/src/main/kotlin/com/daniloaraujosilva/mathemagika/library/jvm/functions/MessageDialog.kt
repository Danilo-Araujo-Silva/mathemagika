 ...
 * Name:             MessageDialog
 *
 * Full name:        System`MessageDialog
 *
 *                   MessageDialog[expr] puts up a standard message dialog that displays expr together with an OK button.
 *                   MessageDialog[expr, {lbl  :> act , lbl  :> act , …}] includes buttons with labels lbl  that evaluate the corresponding act  if clicked.
 * Usage:                                    1       1     2       2                                      i                                    i
 *
 ...
 *
 *                   local: paclet:ref/MessageDialog
 * Documentation:    web: http://reference.wolfram.com/language/ref/MessageDialog.html
 *
 * Definitions:      None
 *
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun messageDialog(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("MessageDialog", arguments.toMutableList(), options)
}
