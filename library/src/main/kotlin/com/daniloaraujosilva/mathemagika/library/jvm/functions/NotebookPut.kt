 ...
 * Usage:            NotebookPut[expr, obj] replaces the notebook represented by the notebook object obj with one corresponding to expr.
 *
 ...
 *
 *                   local: paclet:ref/NotebookPut
 * Documentation:    web: http://reference.wolfram.com/language/ref/NotebookPut.html
 *
 * Definitions:      None
 *
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun notebookPut(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("NotebookPut", arguments.toMutableList(), options)
}
