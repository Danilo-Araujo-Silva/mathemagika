 ...
 * Name:             TextCell
 *
 * Full name:        System`TextCell
 *
 *                   TextCell["string"] gives a text cell that can appear in a Wolfram System notebook.
 *                   TextCell["string", "style"] gives a text cell with the specified style.
 *                   TextCell["string", style , style , …] gives a text cell with multiple styles applied to it.
 * Usage:                                    1       2
 *
 ...
 *
 *                   local: paclet:ref/TextCell
 * Documentation:    web: http://reference.wolfram.com/language/ref/TextCell.html
 *
 * Definitions:      None
 *
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun textCell(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("TextCell", arguments.toMutableList(), options)
}
