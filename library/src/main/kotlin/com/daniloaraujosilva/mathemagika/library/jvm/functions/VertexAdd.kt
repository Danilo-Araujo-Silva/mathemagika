 ...
 *
 *                   local: paclet:ref/VertexAdd
 * Documentation:    web: http://reference.wolfram.com/language/ref/VertexAdd.html
 *
 * Definitions:      None
 *
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun vertexAdd(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("VertexAdd", arguments.toMutableList(), options)
}
