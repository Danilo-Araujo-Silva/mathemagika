 ...
 * Usage:            VertexDelete[{v  w, …}, …] uses rules v  w to specify the graph g.
 *
 ...
 *
 *                   local: paclet:ref/VertexDelete
 * Documentation:    web: http://reference.wolfram.com/language/ref/VertexDelete.html
 *
 * Definitions:      None
 *
 * Own values:       None
 ...
 * Numeric values:   None
 */
fun vertexDelete(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("VertexDelete", arguments.toMutableList(), options)
}
