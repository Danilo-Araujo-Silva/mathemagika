 ...
 * Numeric values:   None
 */
fun `$CloudSymbolBase`(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("\$CloudSymbolBase", arguments.toMutableList(), options)
}
