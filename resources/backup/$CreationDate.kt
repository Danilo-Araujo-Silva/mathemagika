 ...
 *````
 *
 * Name:             DateObject[{2020, 3, 18, 19, 16, 50}, Instant, Gregorian, -3.]
 *
 ...
 */
fun `$CreationDate`(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("\$CreationDate", arguments.toMutableList(), options)
}
