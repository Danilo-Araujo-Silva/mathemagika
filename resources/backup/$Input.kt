 ...
 */
fun `$Input`(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("\$Input", arguments.toMutableList(), options)
}
