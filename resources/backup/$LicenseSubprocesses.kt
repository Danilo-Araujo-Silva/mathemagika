 ...
 */
fun `$LicenseSubprocesses`(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("\$LicenseSubprocesses", arguments.toMutableList(), options)
}
