 ...
 */
fun `$MaxLicenseSubprocesses`(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("\$MaxLicenseSubprocesses", arguments.toMutableList(), options)
}
