 ...
 */
fun `$MaxPrecision`(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("\$MaxPrecision", arguments.toMutableList(), options)
}
