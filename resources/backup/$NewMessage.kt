 ...
 * Numeric values:   None
 */
fun `$NewMessage`(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("\$NewMessage", arguments.toMutableList(), options)
}
