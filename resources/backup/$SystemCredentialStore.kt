 ...
 *````
 *
 * Name:             SystemCredentialStoreObject[<|Backend -> System, Keyring -> Automatic|>]
 *
 ...
 */
fun `$SystemCredentialStore`(vararg arguments: Any?, options: MutableMap<String, Any?> = mutableMapOf()): MathematicaFunction {
	return MathematicaFunction("\$SystemCredentialStore", arguments.toMutableList(), options)
}
